...
export default {
  ...
  initialize() {
    withPluginApi("0.8.7", (api) => {
      const generateName = () => {
        const adjectives = ["Swift", "Mighty", "Brave", "Silent", "Dangerous", "Cunning", "Sly", "Vexing", "Flickering", "Radiant", "Joyous", "Ideal", "Original", "Happy", "Bright", "Blue", "Green", "Purple"];
        const nouns = ["Panda", "Tiger", "Eagle", "Wolf", "Otter", "Lion", "Bear", "Fox", "Deer", "Rabbit", "Bird", "Fish", "Snake", "Lizard", "Turtle", "Shark", "Whale", "Dolphin", "Octopus", "Squid", "Crab", "Lobster", "Shrimp", "Chicken", "Duck", "Goose", "Turkey", "Horse", "Cow", "Sheep", "Goat", "Donkey", "Zebra", "Giraffe", "Elephant", "Rhinoceros", "Hippopotamus", "Crocodile", "Alligator", "Kangaroo", "Koala", "Panda", "Tiger", "Eagle", "Wolf", "Otter", "Lion", "Bear", "Fox", "Deer", "Rabbit", "Cat", "Dog", "Bird", "Fish", "Snake", "Lizard", "Frog", "Turtle", "Shark", "Whale", "Dolphin", "Octopus", "Squid", "Crab", "Lobster", "Shrimp", "Chicken", "Duck", "Goose", "Turkey", "Horse", "Cow", "Sheep", "Pig", "Goat", "Donkey", "Mule", "Zebra", "Giraffe", "Elephant", "Rhino", "Hippo", "Crocodile", "Alligator", "Kangaroo", "Koala", "Hotel", "Apple", "Orange", "Citation", "Roman", "Builder", "Pickaxe", "Obbyist", "Tomorrow"];
